...
NSErrorDomain const TpmsErrorDomain = @"TPMSErrorDomain";
...
- (void)setState:(TpmsDriverState)state {
    _state = state;
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error {
    ...
    if (!writeService || !notifyService) {
        NSError *error = [NSError errorWithDomain:TpmsErrorDomain code:ERROR_WRONG_DEVICE userInfo:nil];
        [self.delegate driver:self onError:error];
    }
}
